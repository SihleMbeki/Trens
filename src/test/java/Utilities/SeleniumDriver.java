...
import testautomation.testing.Base;
...
public class SeleniumDriver {
	...
	public void waitForFrameElement(String xpath) {
		try {
			Duration threeseconds = Duration.ofMillis(20000);
			WebDriverWait wait = new WebDriverWait(driver, threeseconds);
			wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(By.cssSelector(xpath)));
		} catch (Exception e) {
			error = e.getMessage();
			Base.log.error(error);
			Assert.fail();
